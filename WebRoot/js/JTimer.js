...
JTC.config = {
    ...
    dayBgColor : [ '#C3DD89', '#AA66E0', '#F9D23A','#EDECF0'],
...
JTC.dialog = function(){
    ...
    this.getYMSelect = function(){
        ...
        table.setAttribute('style','width:100%;cursor:default;font-size:12px;');
        table.style.cssText = 'width:100%;cursor:default;font-size:12px;';
        var row = table.insertRow(0);
        
        var cell = row.insertCell(0);
        cell.style.width = '50px';
        cell.style.textAlign = 'right';
        var html = '<span id="'+ JTC.config.yearSpan +'" title="点击这里选择年份" style="width:50px;cursor:pointer;" onclick="JTC.events.beginToSelectYear()">2010</span>';
        ...
        html = '<span id="'+ JTC.config.monthSpan +'" title="点击这里选择月份" style="width:40px;cursor:pointer;" onclick="JTC.events.beginToSelectMonth()">10</span>';
    ...
    this.getHeadPanel = function(){
        ...
        var row = table.insertRow(0);
        var cell = row.insertCell(0);
        cell.setAttribute('style','width:23px; height:26px;');
        cell.style.cssText = 'width:23px; height:26px;';
        cell.title = '往前翻 月';
    ...
    //添加了边框样式：border:1px solid black;
    load.setAttribute('style','width:140px;height:160px;font-size:12px;background-color:#eeeeee; position:absolute;border-collapse:collapse;border:1px solid black;');
    //添加了边框样式：border:1px solid black;
    load.style.cssText = 'width:140px;height:160px;font-size:12px;background-color:#eeeeee; position:absolute;border-collapse:collapse;border:1px solid black;'; 
    load.border = 1;
    ...
    div.setAttribute('style','position:absolute; width:142; height:166;z-index:20000; font-size:12px; background-color:lightgreen;display:none;');
    div.style.cssText = 'position:absolute; width:142; height:166;z-index:20000; font-size:12px; background-color:lightgreen;display:none;';
...
//函数调用入口 
// inObj: 触发控件; outObj:输出控件;  format:返回日期的格式; forward:选择方向; today:是否包含今天
JTC.setday = function(inObj,outObj,format,forward, today)
{
