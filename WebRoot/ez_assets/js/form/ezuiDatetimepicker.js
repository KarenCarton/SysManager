...
(function(factory){
  ...
  var Datetimepicker = function (element, options) {
    ...
    this.icons = {
      leftArrow: this.fontAwesome ? 'fa fa-angle-left' : (this.bootcssVer === 3 ? 'fa-arrow-left' : 'fa-arrow-left'),
      rightArrow: this.fontAwesome ? 'fa fa-angle-right' : (this.bootcssVer === 3 ? 'fa-arrow-right' : 'fa-arrow-right')
    }
