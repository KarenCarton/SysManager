...
//qinhy add 2021-03-16 子节点选中，默认选中父节点
	if(flag>0){
...
$.fn.tree.defaults={url:null,method:"post",animate:false,checkbox:false,/*cascadeCheck:false,*/onlyLeafCheck:false,lines:false,dnd:false,data:null,queryParams:{},formatter:function(node){
return node.text;
...
//qianbs modify:timespinner bug:hour,second max to 8
