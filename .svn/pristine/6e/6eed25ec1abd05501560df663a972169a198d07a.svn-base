...
$("select").each(function() {
	...
	if(index >= 0){
		select_value2 = select_value2.substring(index + 5);
	}else{
		select_value2 = select_value2.substring(index2 + 8);
	}
...
$("select").click(function(){
	...
	if(index >= 0){
		select_value1 = select_value1.substring(index + 5);
	}else{
		select_value1 = select_value1.substring(index2 + 8);
	}
...
$(".branch_wrap_left dl").each(function() {
    $(this).children("dt").children("a").click(function() {
        $(this).parent().siblings("dd").stop(true, true);
        $(this).parent().siblings("dd").fadeToggle(200);
